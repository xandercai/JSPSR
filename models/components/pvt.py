...
model_path = {
    "resnet18": "./models/pretrained/ResNet18.pth",
    "resnet34": "./models/pretrained/ResNet34.pth",
}


def get_resnet18(pretrained=True):
    net = torchvision.models.resnet18(weights=False)
    if pretrained:
...
class Block(nn.Module):
    def __init__(
        ...
        self.concat_conv = nn.Conv2d(
            dim * 2, dim, kernel_size=(3, 3), padding=(1, 1), bias=False
        )
